...
func main() {
  ...
  client := evernote.NewNoteStoreClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "getFilteredSyncChunk":
    ...
    argvalue3 := evernote.NewSyncChunkFilter()
  ...
  case "getLinkedNotebookSyncState":
    ...
    argvalue1 := evernote.NewLinkedNotebook()
  ...
  case "getNotebook":
    ...
    value1 := evernote.GUID(argvalue1)
  ...
  case "createNotebook":
    ...
    argvalue1 := evernote.NewNotebook()
  ...
  case "createSearch":
    ...
    argvalue1 := evernote.NewSavedSearch()
  ...
  case "findNoteOffset":
    ...
    argvalue1 := evernote.NewNoteFilter()
    ...
    value2 := evernote.GUID(argvalue2)
  ...
  case "findNotesMetadata":
    ...
    argvalue4 := evernote.NewNotesMetadataResultSpec()
  ...
  case "getNoteWithResultSpec":
    ...
    argvalue2 := evernote.NewNoteResultSpec()
  ...
  case "updateResource":
    ...
    argvalue1 := evernote.NewResource()
  ...
  case "getPublicNotebook":
    ...
    value0 := evernote.UserID(argvalue0)
    argvalue1 := flag.Arg(2)
    value1 := argvalue1
  ...
  case "shareNotebook":
    ...
    argvalue1 := evernote.NewSharedNotebook()
  ...
  case "createOrUpdateNotebookShares":
    ...
    argvalue1 := evernote.NewNotebookShareTemplate()
  ...
  case "setNotebookRecipientSettings":
    ...
    argvalue2 := evernote.NewNotebookRecipientSettings()
  ...
  case "emailNote":
    ...
    argvalue1 := evernote.NewNoteEmailParameters()
  ...
  case "findRelated":
    ...
    argvalue1 := evernote.NewRelatedQuery()
    ...
    argvalue2 := evernote.NewRelatedResultSpec()
  ...
  case "manageNotebookShares":
    ...
    argvalue1 := evernote.NewManageNotebookSharesParameters()
